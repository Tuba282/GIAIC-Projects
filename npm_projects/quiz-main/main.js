...
async function start() {
    ...
    await new Promise((resolve) => {
        figlet("Q U I Z  -  G A M E", function (err, data) {
            if (err) {
...
const Qs = [
    ...
    },
    {
        name: "Question_2",
        type: "list",
        message: chalk.yellowBright("If Laiba's daughter is my daughter's mother what am i...?\n"),
        choices: [
            "Laiba's daughter",
            "Laiba's mother",
            "Laiba's grandmother",
    ...
    },
    {
        name: "Question_3",
        type: "input",
        message: chalk.yellowBright("What is always coming, but never arrives...?\n"),
    ...
    },
    {
        name: "Question_6",
        type: "list",
        message: chalk.yellowBright("Why do some cricket players never sweat ...\nBcause they have...?\n"),
        choices: ["Enimies", "Fans", "Family", "Friends"],
    },
    {
        name: "Question_7",
        type: "list",
        message: chalk.yellowBright("If a plane crashes on the border between the Pakistan and India\n where do they bury the survivors...?\n"),
        choices: ["Heaven", "Hell", "not buried", "Kashmir"],
    },
    {
        name: "Question_8",
        type: "list",
        message: chalk.yellowBright("If you are in a dark room with a candle, a piece of wood  and a gas lamp.\n You only have one match, so what do you light first...?\n"),
    ...
    },
    {
        name: "Question_10",
        type: "input",
        message: chalk.yellowBright("Most of the kids love to carry these keys. What are those keys...?\n"),
        validate: function (value) {
            if (value.trim() !== "") {
                return true;
            }
