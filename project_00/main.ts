...
let famous_person = "Qauid-e-Azam";
...
var array: string[] = ['Nayab', 'Bushra', 'Tuba', 'sara']
...
var array1: string[] = ['train', 'flight', 'bus', 'taxi', 'car', 'bike', 'scooty']
...
var array2: string[] = ['Nayab', 'Bushra', 'Tuba', 'Muneeb', 'Surmad', 'Sara', 'Imran']
...
var array3: string[] = ['Nayab', 'Bushra', 'Tuba', 'Muneeb', 'Surmad']
...
var array4: string[] = ['Nayab', 'Bushra', 'Tuba', 'Muneeb', 'Surmad', 'Sara', 'Imran']
...
var array5: string[] = ['Nayab', 'Bushra', 'Tuba', 'Sara', 'Imran']
...
var array6: string[] = ['Nayab', 'Bushra', 'Tuba', 'Sara', 'Imran', 'Ayesha', 'Maheen', 'Noor']
...
var array6: string[] = ['Nayab', 'Bushra', 'Tuba', 'Sara', 'Imran', 'Ayesha', 'Maheen', 'Noor', 'fatima']
...
const array7: string[] = ['Clifton Beach', 'Gulshan-e-Iqbal', 'Bahria Town', 'Saddar', 'DHA']
console.log("\n");
...
console.log("\n........................Q20.................................");
console.log("\n");
let array8: string[] = ['Mount Everest', 'Indus River', 'Algeria', 'Karachi', '14.5 million']
console.log(array8);
...
var array9: number[] = [22, 12, 15, 14, 89, 20]
...
var favorite_fruits: string[] = ['banana', 'apple', 'guava', 'mango', 'pineapple', 'grapes']
...
console.log("\n");
var list_1: string[] = ['hasan', 'ali', 'kamran', 'akram', 'hussain'] //current_users list
...
console.log("\n");
var list_2: string[] = ['amna', 'ali', 'kamran', 'israr', 'bushra'] //new_users list
...
console.log("\n");
let i: number[] = [1, 2, 3, 4, 5, 6, 7, 8, 9] //ordinal_numbers
...
// I am facing errors in dealing with loops
...
console.log("\n");
console.log(" Use an if-else chain inside the loop to print the proper ordinal ending for each number. Your output should read 1st 2nd 3rd 4th 5th 6th 7th 8th 9th, and each result should be on a separate line");
console.log("\n");
