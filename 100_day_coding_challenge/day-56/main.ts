...
console.log("" + 1 + 0);//10
// console.log("" - 1 + 0);//The left-hand side of an arithmetic operation must be of type 'any', 'number', 'bigint' or an enum type.

// console.log(true + false);Operator '+' cannot be applied to types 'boolean' and 'boolean'.
...
console.log("$" + 4 + 5);//$45
// console.log(null + 1);//The value 'null' cannot be used here.
// console.log(undefined + 1);//The value 'undefined' cannot be used here.
