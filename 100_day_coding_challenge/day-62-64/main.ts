...
console.log(
  `hey buddies my name is ${my_obj.name} and I am ${my_obj.age} Now ${my_obj.friends.now[0]} is
   friend but in old days I uesed to have friend ${my_obj.friends.school[0]} in college and
    ${my_obj.friends.school[0]} in school but being alone a really a good vibe.\n`
);
