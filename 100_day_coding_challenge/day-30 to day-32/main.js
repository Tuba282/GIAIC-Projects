...
function rounding_number(num_1) {
    return Math.round(num_1);
}
console.log(chalk.bgBlueBright `Round of 12.6 is ` + ` ` + rounding_number(12.6));
...
//using .push()
function add_element_from_the_end(...element) {
    // let array=[]
    // array.push(element);
    console.log(element);
}
add_element_from_the_end(`nayab`, `tuba`);
function using_push(element) {
    let array = [`red`, `green`];
    console.log(array);
    array.push(element);
    console.log(array);
