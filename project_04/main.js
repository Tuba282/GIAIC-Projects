...
const per = await inquirer_1.default.prompt([
    {
        message: "Enter your report card number (soch samjh k enter karna warna bapo sy bhut pary gi):",
