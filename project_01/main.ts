...
Variable 3 types....
1)Let          ( let update kar sakty hain or 1name k 2 variables ni ban sakty error ata hy )
2)var          ( var   main error nhi ata hy )
3)const        ( const  update  nahi kar sakty or 1 name k 2 variables ni ban sakty error main  ata hy )
